      ...
      <div className="header-container">
        ...
        <div className="header-actions">
          <a href={links.telUrl} className="header-phone-link" aria-label={`Call Tropical Spa at ${business.phone}`}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="14" height="14" style={{ marginRight: '6px', fill: 'currentColor', display: 'inline-block', verticalAlign: 'middle' }}>
